...
from dvc.commands.clearml import (
    apply,
    branch,
    clean,
    diff,
...
def add_parser(subparsers, parent_parser):
    EXPERIMENTS_HELP = "Commands to run and compare Clearml experiments."
    ...
    experiments_subparsers = experiments_parser.add_subparsers(
        dest="cmd",
        help="Use `dvc clearml CMD --help` to display command-specific help.",
    )
